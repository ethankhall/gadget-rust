use gadget_backend::prelude::BackendRedirect;
...
impl From<BackendRedirect> for AliasRedirect {
    fn from(value: BackendRedirect) -> Self {
...
fn long_url_with_spaces() {
    ...
    let alias = AliasRedirect::new(
        "google".to_owned(),
        "https://duckduckgo.com/{?q=$1}".to_owned(),
    );
